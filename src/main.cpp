...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    if((nHeight >= 66000) || (fTestNet && (nHeight >= 60))) {
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf71da22e2f7ef546bafc2857246a21d221bf330dbffab3f887cd262acdc5de19");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "i want to buy a house by the lake but i will never have enough money";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0xf1b7304c1fbb02c2db4f4fed5349d0356b825326ad9fce002f94c1695018240a"));
